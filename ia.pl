...
jouerCoup(N,Plateau,Couleur,NewPlateau) :- N > 6, N1 = 1, jouerCoup(N1,Plateau,Couleur,NewPlateau).
...
setProfondeur(Plateau,P,NP) :-
    nth1(4,Plateau,L4), length(L4,I4), I4>4, nth1(5,Plateau,L5), length(L5,I5), I5>4, 
    P>2, NP is P-2, !.
